...
{
    public partial class Jobsus : UserControl
    {
        public Jobsus()
        {
            InitializeComponent();
        ...
        private void Jobsus_Load(object sender, EventArgs e)
        {
            string source = @"Data Source=DESKTOP-O8UDH05;Initial Catalog=APRO;Integrated Security=True";
            SqlConnection con = new SqlConnection(source);
            con.Open();

            string sqlselectquery = "select * from sell where category = 'Jobs' order by p_id asc ";
        ...
        private void Jobsus_MouseHover(object sender, EventArgs e)
        {
            ...
            string sqlquery = "select top 2 * from sell where category = 'Jobs' order by p_id desc ";
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            add.Show();
            setvalueforjob1= tb_Username.Text;
        }
