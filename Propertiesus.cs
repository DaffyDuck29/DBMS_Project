...
{
    public partial class Propertiesus : UserControl
    {
        public Propertiesus()
        {
            InitializeComponent();
        ...
        private void Propertiesus_Load(object sender, EventArgs e)
        {
            string source = @"Data Source=DESKTOP-O8UDH05;Initial Catalog=APRO;Integrated Security=True";
            SqlConnection con = new SqlConnection(source);
            con.Open();

            string sqlselectquery = "select * from sell where category = 'Properties' order by p_id asc ";
        ...
        private void Propertiesus_MouseHover(object sender, EventArgs e)
        {
            string source = @"Data Source=DESKTOP-O8UDH05;Initial Catalog=APRO;Integrated Security=True";
            ...
            string sqlquery = "select top 2 * from sell where category = 'Properties' order by p_id desc ";
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            add.Show();
           setvalueforprop1= tb_Username.Text;
        }
        ...
        private void label3_Click(object sender, EventArgs e)
        {
            add_Messages add = new add_Messages();
            add.Show();
            setvalueforprop2= textBox2.Text;
        }
    }
    }
